...
%\fi
\SetAlgorithmName{\hei{算法}}{\hei{算法列表}}
...
%附录
\renewcommand\appendixname{\hei{附录}}
\renewcommand\appendixpagename{\hei{附录}}

%fancyref本地化
\renewcommand\Frefappname{附录}
\renewcommand\Frefalgname{算法}
\frefformat{plain}{\fancyrefseclabelprefix}{第#1节}